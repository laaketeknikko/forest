...
import { version } from "../../../../node_modules/@react-three/drei/helpers/constants"
...
declare global {
   ...
   namespace JSX {
      interface IntrinsicElements {
         gridMaterial: JSX.IntrinsicElements["shaderMaterial"] &
            GridMaterialType
      }
   }
}
  ...
  `,
   /* glsl */ `
    ...
    void main() {
      ...
      float dist = distance(worldPlanePosition, worldPosition.xyz);
...
export const CustomGrid: ForwardRefComponent<
